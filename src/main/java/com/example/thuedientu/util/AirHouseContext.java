...
public class AirHouseContext {
    @Getter
    private final BlockingQueue<List<AirHouseBillEntity>> queue;
    ...
    public AirHouseContext(BlockingQueue<List<AirHouseBillEntity>> queue, String fileName) {
        this.queue = queue;
