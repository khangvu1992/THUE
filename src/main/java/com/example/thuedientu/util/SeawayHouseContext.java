...
public class SeawayHouseContext {
    @Getter
    private final BlockingQueue<List<SeawayHouseBillEntity>> queue;
    ...
    public SeawayHouseContext(BlockingQueue<List<SeawayHouseBillEntity>> queue, String fileName) {
        this.queue = queue;
