...
//                progressWebSocketSender.sendProgress1("fileId, ctx.getFileName(), ctx.getProcessedCount(), ctx.getQueue().size(), ctx.isReadingDone(), ctx.getErrorMessage()");
    ...
    BEGIN
        CREATE TABLE air_house_bill (
            ...
            TENNOIDI NVARCHAR(255),
            MANOIDEN NVARCHAR(255),
            TENNOIDEN NVARCHAR(255),
            FI_MAQUACANH NVARCHAR(255),
            IDHANGHOA NVARCHAR(255),
            ID_HHCT NVARCHAR(255),
            FI_SOAWB NVARCHAR(255),
            FI_SOKIEN INT,
            FI_MOTA NVARCHAR(4000),
            FI_SHC NVARCHAR(255),
            TRONGLUONG DECIMAL(20,3),
            NOIDIHH NVARCHAR(255),
            NOIDENHH NVARCHAR(255),
            FI_LOAIHANG NVARCHAR(255)
        )
    END
    """;
